...
appController = {
  ...
  toggleSidePanelScript: function(){
    ...
    var openSidePanel = function(){
      ...
      newElement.setAttribute("style", "z-index: 999999999999999; position: fixed; top: 0px; right: 0px; bottom: 0px; width: 300px; height: 100%; border-left: 1px solid #eee; box-shadow: 0px -1px 7px 0px #aaa; overflow-x: hidden;");
